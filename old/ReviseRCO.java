...
public class ReviseRCO extends JFrame implements ActionListener{
    ...
    public ReviseRCO(RCO rco){
        this.rco = rco;
    	setTitle("Revise "+rco.name);
	setLocation(220, 150);
	setSize(1000,500);
	setResizable(false);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        this.rco.revisions.add(rco);
        rco.name = String.format("RCO #%d Rev%d", RCO.list.indexOf(this.rco)+1, this.rco.revisions.indexOf(rco)+1);
        this.dispose();
