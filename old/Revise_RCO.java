...
public class Revise_RCO extends RCOwindow implements ActionListener{    
    RCO parentRCO,rco;
    ...
    Revise_RCO(){
        ...
        model_M = (DefaultTableModel) table_M.getModel();
        table_L.setModel(rco.model_L); 
        model_L = (DefaultTableModel) table_L.getModel();
        table_O.setModel(rco.model_O);
        model_O = (DefaultTableModel) table_O.getModel();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()== b_Save){
            ...
            this.parentRCO.revisions.add(rco);
            rco.name = String.format("RCO #%d Rev%d", parentRCO.project.rcolist.indexOf(parentRCO)+1, parentRCO.revisions.indexOf(rco)+1);
